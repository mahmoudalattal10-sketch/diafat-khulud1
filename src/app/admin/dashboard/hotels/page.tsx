                                ...
                                {activeTab === 'basic' && (
                                    <div className="space-y-10">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            ...
                                            <div className="space-y-2"><label className="text-sm font-black text-gray-600 mr-2">سعر البداية</label><input type="number" value={currentHotel?.price} onChange={(e) => setCurrentHotel({ ...currentHotel, price: Number(e.target.value) })} className="w-full h-14 px-6 bg-gray-50 rounded-2xl border border-transparent focus:bg-white focus:border-primary-500 outline-none font-bold" /></div>
                                            ...
                                            {currentHotel.rooms?.map((room: any, idx: number) => (
                                                <div key={idx} className="bg-gray-50 rounded- [2.5rem] p-8 border border-transparent hover:border-primary-500/20 transition-all">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                                        ...
                                                        <div className="space-y-2"><label className="text-[10px] font-black text-gray-400 uppercase tracking-widest mr-2">السعر / الليلة</label><input type="number" value={room.price} onChange={(e) => updateRoom(idx, 'price', Number(e.target.value))} className="w-full h-12 px-4 bg-white rounded-xl border border-gray-100 font-bold text-sm" /></div>
                                                    </div>
